namespace Lesson5.Models
{
    ...
    internal class Triangle : GeometricShape
    {
        ...
        /// <summary>
        /// Получить\задать размер основания треугольника. Основание должно быть больше нуля.
        /// </summary>
        public double Basis
        {
            get => _basis;
        ...
        /// <summary>
        /// Получить\задать размер левого ребра треугольника. Левое ребро должно быть больше нуля.
        /// </summary>
        ...
        /// <summary>
        /// Получить\задать размер правого ребра треугольника. Правое ребро должно быть больше нуля.
        /// </summary>
        ...
        /// Каждый аргумент не может быть больше суммы двухдругих.
        /// </summary>
